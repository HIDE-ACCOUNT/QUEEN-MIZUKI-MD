...
cmd({
        ...
        use: '947581799XX,Your_text_here',
        filename: __filename,
  },
...
╔════◇
║ _QUEEN-MIZUKI-MD-REPO_ 💃
║ _CREATED BY KALINDU 🧚‍♂️._
╚═════════════════◉

╔═════◇
║    
║    *OWNER:* _wa.me//+94758179948_
║
║    *REPO:* _github.com/MR-KALINDU/QUEEN-MIZUKI-MD_
║
╚═════════════════◉`
...
cmd({
        pattern: "link",
        alias: ["ytube", "yt", "myyt"],
        desc: "Sends info about My Ytube Channel __CheckOut :_ www.Youtube.com/c/kalidu_official",
        category: "general",
        filename: __filename,
    },
    async(Void, citel) => {
...
╚══════════════════════════╝\n
*🍁 Channel Link:* _https://youtube.com/kalidu_official?sub_confirmation=1_\n
╭━━━━━━━━━━━━━━━━━━━━╮
┇  ╔═╦╗╔╦╗╔═╦═╦╦╦╦╗╔═╗
┇  ║╚╣║║║╚╣╚╣╔╣╔╣║╚╣═╣
┇  ╠╗║╚╝║║╠╗║╚╣║║║║║═╣
...
*🌟Description:* A WhatsApp bot with rich features, Created By *KALINDU*.\n
*⚡Speed:* ${latensie.toFixed(4)} ms
*🚦Uptime:* ${runtime(process.uptime())}
*🕸Version:* 1.0.0
*👤Owner:*  ${Config.ownername}\n\n
*Powered by 'MR-KALINDU'*
\n\n${Config.caption}`;
        let buttonMessaged = {
            image: { url: await botpic() },
            caption: ter,
