...
cmd({
		...
		for ( count ; count < limit ; count++) 
		{
		 // if (count >= limit) break;
		  ...
		  if(isSticker) { let a = await getBuffer(sticUrl); await citel.reply(a, { packname: Config.packname, author: "MIZUKI-Md"  }, "sticker");} 
...
try {
	...
	{ 
	        ...
	        let buttonMessage = 
		{
			...
			caption : "\t  *MIZUKI GOOGLE DRIVE DOWNLOADER*  \n" + data
		}
